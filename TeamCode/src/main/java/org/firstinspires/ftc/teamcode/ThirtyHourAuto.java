...
@Autonomous(name="ThirtyHourAuto", group = "ThirtyHour")
public class ThirtyHourAuto extends LinearOpMode
{
    // Adjust these numbers to suit your robot. well how the fuck do you charge it
